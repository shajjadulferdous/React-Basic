        ...
        <div className='flex justify-center items-center mt-15'>
            <div >
                ...
                <div className='flex justify-center items-center mt-3'>
                    ...
                    <input type="radio" name="my_tabs_1" className="tab bg-linear-to-r from-[#4F39F6] to-[#655da4] text-white px-4 py-2 rounded-full" onClick={ ()=>{SetState(false)}} aria-label="Products" defaultChecked />

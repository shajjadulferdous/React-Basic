       ...
       <>
        ...
        <div className='flex mx-auto w-12/16 my-10 sm:my-15 gap-15 flex-col md:flex-row'>
            <div className='flex-1 flex justify-center items-center text-start'>
                  <div>
                 <p className='flex bg-[#E1E7FF] py-2 px-3 rounded-full w-fit gap-2 mb-4 items-center justify-center '>  <VscDebugBreakpointLog className='bg-blue-200 animate-pulse' />
